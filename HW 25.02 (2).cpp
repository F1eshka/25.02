...
int main()
{
	...
	int* ar;
	sll.AddToTail(10); // 10
	sll.AddToTail(20); // 10 20
	sll.AddToTail(30); // 10 20 30
	sll.AddToTail(40); // 10 20 30
	sll.AddToTail(50); // 10 20 30
	sll.AddToTail(40); // 10 20 30 40
	cout << sll;
	sll.Print();

	sll2.AddToTail(10); // 10
	sll == sll2;
	sll != sll2;

	sll2.AddToTail(20); // 10 20
	sll2.AddToTail(30); // 10 20 30
	sll2.AddToTail(40); // 10 20 30
	sll2.AddToTail(50); // 10 20 30
	sll2.AddToTail(40); // 10 20 30 40
